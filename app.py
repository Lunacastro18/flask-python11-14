...
# RUTAS PÚBLICAS E INFORMACIÓN
@app.route("/")
def index():
    return render_template(
        "index.html", 
        estudiante="Luna Castro", 
...
def recursos():
    enlaces = [
        {"nombre": "Documentacion Flask", "url": "https://palletsprojects.com"},
        {"nombre": "Tutorial Python", "url": "https://python.org"},
        {"nombre": "GitHub del Profesor", "url": "https://github.com"},
        {"nombre": "MDN - HTML y CSS", "url": "https://mozilla.org"}
    ]
    ...
    if request.method == "POST":
        ...
        if not nombre or not email or not programa:
            ...
            try:
                ...
                db.session.commit()
                mensaje = f"¡Bienvenido {nombre}! Te hemos registrado en la base de datos."
            except Exception as e:
                db.session.rollback()
                mensaje = "Error: Este email ya está registrado en el sistema."
...
# SISTEMA CRUD DE TAREAS (PROFESOR)
